...
import { 
  ...
  FaExternalLinkAlt, 
  FaCode,
  FaMobile,import React, { useState, useRef } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { useTheme } from '../contexts/ThemeContext';
import { trackEvent } from '../hooks/useAnalytics';
import { 
...
const projectsData = [
  {
    id: 1,
    title: "A One Recovery Service",
    description: "A professional 24/7 car towing and recovery service website for Rawalpindi, built with React 19 and SEO-optimized for local search visibility.",
    image: "/images/projects/a-one-recovery.svg",
    technologies: ["React", "Vite", "Tailwind CSS", "Framer Motion"],
    category: "frontend",
    liveUrl: "https://a-one-recovery.vercel.app",
    githubUrl: null,
    featured: true
  },
  {
    id: 2,
    title: "Crystal Recovery Service",
    description: "A professional 24/7 car recovery and towing service website for Dubai, built with Next.js App Router and a modern SEO-optimized design.",
    image: "/images/projects/crystal-recovery-service.svg",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS"],
    category: "frontend",
    liveUrl: "https://crystal-recovery-service.vercel.app",
    githubUrl: "https://github.com/Aic73/crystal-recovery-service",
    featured: true
  },
  {
    id: 3,
    title: "LUXE MART",
    description: "A smart local business product showcase and e-commerce style storefront for a premium local store.",
    image: "/images/projects/luxe-mart.svg",
    technologies: ["React", "Tailwind CSS", "Framer Motion"],
    category: "frontend",
    liveUrl: "https://luxe-mart-ochre.vercel.app",
    githubUrl: "https://github.com/Aic73/luxe-mart",
    featured: false
  },
  {
    id: 4,
    title: "Karachi Student Biryani",
    description: "A restaurant-style ordering website built to showcase menu items, pricing, and an online cart experience.",
    image: "/images/projects/karachi-student-biryani.svg",
    technologies: ["React", "Tailwind CSS"],
    category: "frontend",
    liveUrl: "https://karachi-student-biryani.vercel.app",
    githubUrl: "https://github.com/Aic73/karachi-student-biryani",
    featured: false
  }
];
